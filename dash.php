                                ...
                                ?>
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="w-100 d-flex flex-column align-items-end">
                                                    <!-- <button class="btn btn-md btn-primary mt-3 p-2" style="width: 25%; background-color: #548CFF; border-radius: 12px; font-size: .9rem; border: none;">Update</button> -->
                                                    <a href="./dash_edit.php" style="width: 25%;">
                                                        <button class="btn btn-md btn-primary mt-3 p-2" style="width: 100%; background-color: #548CFF; border-radius: 12px; font-size: .9rem; border: none;">Update</button>
                                                    </a>
                                                </div>
                                                <!-- <a href="./dash_edit.php"> <button class="btn btn-md btn-primary mt-3 p-2" style="width: 25%; background-color: #548CFF; border-radius: 12px; font-size: .9rem; border: none;">Update</button> </a> -->
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                if ($icon_img == NULL) {
                                                ?>
                                                    <img class="img-fluid mb-4" style="width: 15rem;" src="./assets/img/image.png" alt="...">
                                                <?php
                                                } else {
                                                ?>
                                                    <img class="img-fluid mb-4" style="width: 15rem;" src="./files/<?php echo $icon_img; ?>" alt="...">
                                                <?php
                                                }
                                                ?>
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                ...
                                                ?>
                                                    <img class="img-fluid mb-4" style="width: 15rem;" src="./files/<?php echo $bg_img; ?>" alt="...">
                                                <?php
                                                }
                                                ?>
                                            </div>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <label class="custom-field one col-sm-4">
                                                <input type="text" class="w-100" placeholder=" " value="<?php echo $business_name; ?>" readonly />
                                                <span class="placeholder">Business Name*</span>
                                            </label>
                                            <label class="custom-field one col-sm-4">
                                                <input type="text" class="w-100" placeholder=" " value="Not Set" readonly />
                                                <span class="placeholder">Business Place*</span>
                                            </label>
                                            <label class="custom-field one col-sm-4">
                                                <input type="text" class="w-100" placeholder=" " value="<?php echo $category; ?>" readonly />
                                                <span class="placeholder">Primary Category*</span>
                                            </label>
                                        </div>
                                        <div class="row">
                                            <label class="custom-field one col-sm-4">
                                                <input type="text" class="w-100" placeholder=" " value="<?php echo $website; ?>" readonly />
                                                <span class="placeholder">Business Website*</span>
                                            </label>
                                            <label class="custom-field one col-sm-4">
                                                <input type="text" class="w-100" placeholder=" " value="<?php echo $b_contact; ?>" readonly />
                                                <span class="placeholder">Business Phone Number*</span>
                                            </label>
                                            <label class="custom-field one col-sm-4">
                                                <input type="text" class="w-100" placeholder=" " value="<?php echo $b_email; ?>" readonly />
                                                <span class="placeholder">Business Email Address*</span>
                                            </label>
                                        </div>
                                        <div class="row">
                                            <label class="custom-field one col-sm-4">
                                                <input type="text" class="w-100" placeholder=" " value="<?php echo $tags; ?>" id="tagInput" readonly />
                                        ...
                                        <div class="row">
                                            <label class="custom-field one col-sm-12">
                                                <textarea class="w-100" rows="3" placeholder=" " readonly><?php echo $description; ?></textarea>
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="Enter Facebook Link" value="<?php echo $facebook; ?>" readonly />
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="Enter Instagram Link" value="<?php echo $instagram; ?>" readonly />
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="Enter LinkedIn Link" value="<?php echo $linkedin; ?>" readonly />
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="Enter Skype Link" value="<?php echo $skype; ?>" readonly />
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="Enter Twitter Link" value="<?php echo $twitter; ?>" readonly />
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" placeholder="Enter Pinterest Link" value="<?php echo $pinterest; ?>" readonly />
                                            </div>
                                            <div class="col-sm-4">
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input toggle-switch" type="checkbox" role="switch" id="switch1" checked disabled>
                                                    <label class="form-check-label switch-label" for="switch1">Open</label>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 d-flex">
                                                <input type="time" class="form-control col-sm-4" name="" id="" value="12:00" readonly>
                                                <p class="col-sm-1 align-items-center">TO</p>
                                                <input type="time" class="form-control col-sm-4" name="" id="" value="23:00" readonly>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-sm-3 d-flex align-items-center">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input toggle-switch" type="checkbox" role="switch" id="switch2" checked disabled>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input toggle-switch" type="checkbox" role="switch" id="switch3" checked disabled>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input toggle-switch" type="checkbox" role="switch" id="switch4" checked disabled>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input toggle-switch" type="checkbox" role="switch" id="switch5" checked disabled>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input toggle-switch" type="checkbox" role="switch" id="switch6" checked disabled>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input toggle-switch" type="checkbox" role="switch" id="switch7" checked disabled>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary" href="./back/operation/logout.php">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
