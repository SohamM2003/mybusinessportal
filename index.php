<?php
include_once('./back/include/db.php');
?>
...
<head>
    ...
    <title>Login for Business | SM</title>
</head>
                        ...
                        <div class="col">
                            <div class="d-flex justify-content-center align-items-center vh-100">
                                <div class="col-12 col-lg-7 my-5 p-2">
                                    ...
                                    <div class="p-3">
                                        <!-- Login Form -->
                                        <form method="post" action="./back/operation/signin.php">
                                            <div class="form-group">
                                                <input type="text" class="form-control my-3 p-2" name="email" placeholder="Enter Your Email" style="width: 100%;">
                                            </div>
                                            <div class="form-group">
                                                <input type="password" class="form-control my-3 p-2" name="password" placeholder="Enter Your Password" style="width: 100%;">
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-center mb-2">
                                                ...
                                                <a href="./signup.php" style="text-decoration: none;">Signup Here!</a>
                                            </div>
                                            <!-- Login Button -->
                                            <div class="text-center">
                                                <input type="submit" class="btn btn-md" name="login" value="Login" style="width: 70%; background-color: #548CFF; border-radius: 12px;">
                                            </div>
